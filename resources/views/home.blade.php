      ...
      <div class="container">
        <div class="flex flex-wrap w-full justify-center">
          <div class="py-6 w-full px-4 text-center md:w-1/2 lg:w-1/3">
            <img src="img/ident.png" alt="Identitas" class="mx-auto" />
          ...
          <div class="py-6 w-full px-4 text-center md:w-1/2 lg:w-1/3">
            <img src="img/visi.png" alt="Visi Misi" class="mx-auto" />
            <h2 class="font-bold text-xl text-three my-6">Visi Misi</h2>
            <p class="font-medium text-sm text-secondary mb-4">Hight School berdiri sejak tahun 1980 dengan nama Hight School 1. Sekolah yang akan membimbing muridnya hingga benar</p>
            <a href="#" class="font-semibold text-sm text-primary">Read more</a>
          </div>
          <div class="py-6 w-full px-4 text-center md:w-1/2 lg:w-1/3">
            <img src="img/struktur.png" alt="Struktur Sekolah" class="mx-auto" />
          ...
          <div class="container mb-28">
            ...
            <div class="flex flex-wrap gap-4">
              <div class="w-full text-center py-6 px-4 border rounded-xl md:w-[48%]">
                <img src="img/ips.png" alt="IPS" class="mx-auto" />
              ...
              <div class="w-full text-center py-6 px-4 border rounded-xl md:w-[48%]">
                <img src="img/ipa.png" alt="IPS" class="mx-auto" />
        ...
        <section id="artikel">
          ...
          <div class="lg:columns-2">
            <div class="mb-3 relative cursor-pointer">
              <img src="img/artikel 1.png" alt="" class="h-full w-full" />
            ...
            <div class="mb-3 cursor-pointer">
              <img src="img/artikel 2.png" alt="" class="lg:float-left mr-4" />
            ...
            <div class="mb-3 cursor-pointer">
              <img src="img/artikel 3.png" alt="" class="lg:float-left mr-4" />
              <div class="w-full py-3">
                <p class="text-sm font-medium text-slate-500">September 2, 2022</p>
        ...
        <div class="flex flex-wrap w-full">
          <div class="w-full mb-10 p-6 md:w-1/2 lg:w-1/4">
            ...
            <div class="flex gap-x-4">
              <img src="img/medsos/facebook.png" alt="" />
              <img src="img/medsos/Twitter.png" alt="" />
              <img src="img/medsos/linkedin.png" alt="" />
              <img src="img/medsos/instagram.png" alt="" />
            </div>
          </div>
          <div class="w-full mb-10 p-6 md:w-1/2 lg:w-1/4">
          ...
          <div class="w-full mb-10 p-6 md:w-1/2 lg:w-1/4">
            ...
            <div class="flex items-start w-full mb-4 gap-4">
              <img src="img/location.png" alt="alamat" />
            ...
            <div class="flex items-start w-full gap-4">
              <img src="img/mail.png" alt="kontak" />
              <div class="font-medium text-sm">
